...
public class MainActivity extends AppCompatActivity {
    ...
    private List<TopRecyclerPojo> bookingRecyclerPojoList = new ArrayList<>();;
    private TopRecyclerPojo bookingRecyclerPojo;
    ...
    private void addImageView(){
        ...
        for (int i = 0; i<image.length; i++){
            bookingRecyclerPojo = new TopRecyclerPojo(""+i,  image[i]);
          //  bookingRecyclerPojo.setIcon(image[i]);
            bookingRecyclerPojoList.add(bookingRecyclerPojo);
        }
        TopRecyclerAdapter adapter = new TopRecyclerAdapter(bookingRecyclerPojoList, R.layout.recycler_child, getApplicationContext());
